...
- **Location-based discovery** — traveller enters a city/town and radius; we show experiences within that area on a live map, with option to find local guides
...
| [MAPS-GEO.md](MAPS-GEO.md) | Maps & geo (Leaflet · OSRM) | **F8** city + radius search with map · **F9** map browse · **Find a Guide** · My Location · Offline map tiles |
...
3. **First build task:** DATA + MAPS verify demo villages on the corridor (real settlements within 10 km of NH-48)
